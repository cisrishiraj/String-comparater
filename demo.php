<?php
/*
* String comparater (v1)
* version : 1.0.1
*/

require('diffrence.inc.php');
 
$before = IsSet($_POST['before']) ? $_POST['before'] : 'Rishiraj verma code';
$after = IsSet($_POST['after']) ? $_POST['after'] : 'This is the raj code';
